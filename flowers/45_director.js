...
// Frames between field re-measurements (origins, heights, flower centres).
// The scan touches every axis point and every floral bound, so it is throttled;
// nothing it measures moves fast enough for half a second of staleness to show.
const FL_DIR_SCAN = 30;
